...
class Shiba(Dogs):  #定義子類別Shiba為Dogs的一種
    def __init__(self, weight, mood):  #建構式
        super().__init__(weight, mood)  #執行父類別的方法
